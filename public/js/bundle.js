...
var Client = (function () {
  function Client(id, peer, socket) {
  ...
  _createClass(Client, [{
    ...
    value: function answerCall(call) {
      (0, _getcam2.default)().then(function (selfStream) {
    ...
    value: function callPeer(id) {
      ...
      (0, _getcam2.default)().then(function (selfStream) {
        _ui2.default.setSelfStream(selfStream);
        var call = _this.peer.call(id, selfStream);
        call.once('stream', function (peerStream) {
          _ui2.default.setPeerStream(peerStream);
          _ui2.default.setMode('connected');
        });
